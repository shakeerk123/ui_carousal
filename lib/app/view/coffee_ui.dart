...
import 'package:ui_coffee/app/model/data.dart';
import 'package:ui_coffee/app/view/image_viewer.dart';
    ...
    return Column(
      children: [
        ...
        CarouselSlider(
          ...
          /// Items
          items: AppData.images.map((imagePath) {
            return Builder(
              builder: (BuildContext context) {
                /// Custom Image Viewer widget
                return ImageViewer.show(
                    context: context,
                    url: imagePath,
                    fit: BoxFit.fill,
                    radius: 0);
